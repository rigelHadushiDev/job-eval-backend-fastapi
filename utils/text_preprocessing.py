...
def clean_text(text: str) -> str:
    ...
    exclude_words = {
        "overview", "key", "responsibility", "required", "qualification",
        "about", "role", "background", "tool", "technology"
    }

    stop_words = set(stopwords.words('english'))
    tokens = [t for t in tokens if t not in stop_words and t not in exclude_words]
